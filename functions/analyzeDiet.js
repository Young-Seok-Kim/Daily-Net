...
const prompt = `
            ...
            1. **칼로리 산출 로직 고정**:
               ...
               - **브랜드·제품명이 적혀 있으면 그 제품이 공표한 값을 쓰십시오.**
                 ...
                 - ⚠️ **사용자가 안 적은 브랜드를 붙이지 마십시오.** 이건 적혀 있을 때만 쓰는 규칙입니다.
                   "아메리카노"라고 적었으면 항목 이름도 **"아메리카노"** 그대로 두십시오.
                   "스타벅스 아메리카노"로 바꾸면 사용자는 자기가 안 적은 가게 이름을 보게 되고,
                   실제로 그렇게 나갔습니다. 어느 가게인지는 알 수 없으며 짐작할 일도 아닙니다
