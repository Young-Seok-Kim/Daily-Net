 ...
 *
 * 원래 foodDb.js(식약처 영양 DB 보정)의 일부였다. 보정은 2026-08-07에 걷어냈지만
 * 이 기능은 계산이 아니라 **표시 정리**라서 성격이 다르고, 그래서 여기 남았다.
 * 자세한 사정은 CHANGELOG의 `## 서버 2026-08-07` 항목 참고.
 */
 ...
 * 합치면 안 된다.
 *
 * **낱말 단위로만 뗀다.** 부분 문자열로 지우면 "한우"의 "한", "큰컵라면"의 "큰" 같은
 * 멀쩡한 이름이 깎여 나간다.
 */
